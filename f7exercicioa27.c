...
//para todo x,onde x e o valor do angulo em radianos. Considerar  π = 3.141593 e n variando de 0
//ate 5.

//Make a function caluculate de seno with the serial taylor.
#include <stdio.h>
#include <math.h>
...
int main() {
    ...
    printf("The sine of %.2f degrees is approximately %.2f\n", angleDegrees, sine);
}
